...
<body>
    ...
    <div class="container mt-4">
                ...
                <form action="procesar_horas_extras.php" method="POST">
                    <div class="mb-3">
                        <label for="id_usuario" class="form-label">ID Usuario</label>
                        <input type="number" class="form-control" id="id_usuario" name="id_usuario" required>
                    </div>
                    <div class="mb-3">
                        <label for="horas_extra" class="form-label">Horas Extras</label>
                        <input type="number" class="form-control" id="horas_extra" name="horas_extra" step="0.01" min="0" required>
                        <small class="form-text text-muted">Ingresa la cantidad de horas extras trabajadas.</small>
                    </div>
                    <div class="mb-3">
                        <label for="tipo_quincena" class="form-label">Tipo Quincena</label>
                        <input type="text" class="form-control" id="tipo_quincena" name="tipo_quincena" required>
                    </div>
                    <div class="mb-3">
                ...
                <h2 class="mt-4">Lista de Planillas Registradas</h2>
                <table class="table table-bordered">
                    ...
                    <tbody>
                        <?php
                        // Incluir el archivo PHP para obtener y mostrar los registros
                        include('registrar_horas_extras.php');
