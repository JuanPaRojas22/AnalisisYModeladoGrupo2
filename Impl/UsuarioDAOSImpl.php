...
class UsuarioDAOSImpl implements UsuarioDAO
{
    ...
    mysqli_ssl_set($conexion, NULL, NULL, NULL, NULL, NULL); // ← SIN cargar el CA
    mysqli_options($conexion, MYSQLI_OPT_SSL_VERIFY_SERVER_CERT, false); // ← NO verifica el certificado
